...
def getSecretNum(numDigits):
    # Returns a string that is numDigits long, with a unique random digits.
...
def playAgain():
    # This function returns true if player wants to play again or returns False if not.
...
print('    Fermi       one digit is correct place and position.')
